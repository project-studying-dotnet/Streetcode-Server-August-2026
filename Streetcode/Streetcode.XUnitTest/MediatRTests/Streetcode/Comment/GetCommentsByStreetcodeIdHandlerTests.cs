// <copyright file="GetCommentsByStreetcodeIdHandlerTests.cs" company="PlaceholderCompany">
...
namespace Streetcode.XUnitTest.MediatRTests.Streetcode.Comment
{
    ...
    using global::Streetcode.BLL.MediatR.Streetcode.Comment.GetByStreetcodeId;
    ...
    public class GetCommentsByStreetcodeIdHandlerTests
    {
        ...
        public async Task Handle_ReturnsOnlyRootCommentsForStreetcodeInChronologicalOrder()
        {
            ...
            Assert.Equal(expectedIds, result.Value.Select(comment => comment.Id));
        }
